...
public class ServletUsuarioController extends ServletGenericUtil {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (acao == null || acao.isEmpty() || acao.equalsIgnoreCase("listarUser")) {
	            ...
	            request.getSession().setAttribute("lastUserId", userId);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String[] partesRendaMensal = rendaMensal.split("\\s+");
			if (partesRendaMensal.length > 1) {
			    rendaMensal = partesRendaMensal[1].replaceAll("\\.", "").replaceAll("\\,", ".");
			}
